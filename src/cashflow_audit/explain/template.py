...
_TITLES = {
    ...
    "conflicting_fx": "Курс валюты задан в двух местах с разными значениями",
    "scale_mismatch": "Одна статья в тысячах и в миллионах",
    ...
    "volume_without_wc": "Объём растёт, дебиторка не меняется",
    "volume_without_inventory": "Объём растёт, запасы не меняются",
    "volume_without_ap": "Объём растёт, кредиторка не меняется",
    "volume_without_headcount": "Объём растёт, численность не меняется",
    ...
    "identity.I6": "EBITDA не равна выручка − COGS − OPEX",
    ...
    "identity.I13": "Дивиденды не уменьшают капитал",
    ...
    "frs.F14": "Запас по ковенанту исчерпан",
}
