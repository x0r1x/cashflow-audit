...
- **Не гарантирует полноту** по таблице требований. Сейчас закрыты технические поломки Excel и равенства: баланс, касса, нераспределённая прибыль, валовая прибыль, EBIT, косвенный CFO, график долга, проценты vs ставка. Двойной учёт OPEX в двух SUM, налоги, сценарии — в бэклоге, см. [требования](требования.md).
...
**Ещё нет:** двойной учёт в двух SUM, налог vs ставка, сценарии, точка безубыточности, NPV/IRR, ковенанты пользователя.
