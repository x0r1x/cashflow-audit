...
**Ещё нет:** двойной учёт в двух SUM, график ОС, сценарии, точка безубыточности, NPV/IRR, ковенанты пользователя.
