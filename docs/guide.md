...
**Техника Excel:** ошибки ячеек, циклы, внешние ссылки, VBA/XLM как флаг, разрыв формулы по периодам, константа в формуле, замена формулы числом, неполный `СУММ`, статья в двух `СУММ`, скрытые входы, неиспользуемые ячейки, live-итоги с разных scenario-листов.
