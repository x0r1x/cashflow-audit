...
| Долг (I10) | Начало + выборка − погашение ± mapped FX ≠ конец |
...
- I10 — график долга: начало + выборка − погашение ± mapped переоценка долга = конец. Нет FX-строки — курс не выдумываем.
