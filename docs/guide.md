...
- I3a — касса и **net** денежный поток (не один CFO; иначе capex даёт ложный разрыв) ± mapped переоценка кассы. Mapped касса на балансе и в ОДДС — равенство EoP. Нет второй кассы — не выдумываем. Нет FX-строки — курс не выдумываем.
