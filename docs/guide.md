...
- **Не гарантирует полноту** по таблице требований. Сейчас закрыты технические поломки Excel и равенства: баланс, касса, нераспределённая прибыль, валовая прибыль, EBIT, амортизация P&L vs add-back в ОДДС, косвенный CFO, график долга, проценты vs ставка, налог vs ставка; двойной учёт статьи в двух SUM. Сценарии, график ОС — в бэклоге, см. [требования](требования.md).
...
**Ещё нет:** график ОС, сценарии, точка безубыточности, NPV/IRR, ковенанты пользователя.
