...
**Техника Excel:** ошибки ячеек, циклы, внешние ссылки, VBA/XLM как флаг, разрыв формулы по периодам, константа в формуле, замена формулы числом, неполный `СУММ`, статья в двух `СУММ`, скрытые входы, неиспользуемые ячейки.
...
**Ещё нет:** переключатель сценария (P&L Base, долг Upside), ставки в стресс-сценарии, точка безубыточности, NPV/IRR, ковенанты пользователя.
