...
**Ещё нет:** ставки в стресс-сценарии, точка безубыточности, NPV/IRR, ковенанты пользователя.
