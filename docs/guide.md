...
| Дивиденды (I13) | Капитал ≠ начало + прибыль − дивиденды ± mapped эмиссия |
...
- I13 — капитал: начало + прибыль − дивиденды + mapped эмиссия = конец. Дивиденды в ОДДС, капитал не падает — error. Нет эмиссии — не выдумываем.
