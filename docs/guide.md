...
| График ОС (I8b) | Начало + capex − D&A ± mapped FX ≠ конец |
...
- I8b — график ОС: начало + capex − D&A ± mapped переоценка ОС = конец (capex-отток в ОДДС берётся по модулю). Нет FX-строки — курс не выдумываем.
